...
public final class AutoConnectTileService extends TileService {
    ...
    @Override public void onClick() {
        ...
        android.content.SharedPreferences preferences = getSharedPreferences("autoconnect", MODE_PRIVATE);
    ...
    static void requestUpdate(Context context) {
        requestListeningState(context, new ComponentName(context, AutoConnectTileService.class));
    }
}
